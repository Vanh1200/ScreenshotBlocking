        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (path.contains("screenshot", true)) {
                    // do something
                    Toast.makeText(context,"m vừa chụp ảnh đúng không, link đây: $path", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (name.contains("screenshot", true) or
                    ...
                    // do something
                    Toast.makeText(context, "m vừa chụp ảnh đúng không, link đây: $name", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
